...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('partnership')
        .setDescription('Send a partnership ad to the partnership channel.')
        .addStringOption(o => o.setName('ad').setDescription('The partnership advertisement message.').setRequired(true))
    ...
    async execute(interaction) {
        ...
        if (!channel) {
            return interaction.reply({ content: '❌ Partnership channel not found. Set `CHANNEL_ID` in partnership.js.', flags: MessageFlags.Ephemeral });
        }
        ...
        await interaction.reply({ content: `✅ Partnership ad posted to ${channel}.`, flags: MessageFlags.Ephemeral });
    },
};
